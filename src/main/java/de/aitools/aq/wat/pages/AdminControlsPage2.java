...
public class AdminControlsPage2 extends AdminPage {

	public AdminControlsPage2(final String projectName) throws NullPointerException
	{
		super(projectName);
	}
...
//		this.makeButton(
//				output,
//				WatServlet.ADMIN_ACTION_RESULTS_MATRICES,
//				"Writes the coincidence matrices and reliability matrices files of all completed tasks to the "
//						+ "'matrices' directory in the server directory (TXT-files).");
